...
static void initRelations(TestBuilder *const me)
{
    ...
    // WavaformDisplay_Init(&(me->itsWaveformDisplay));
    ...
    // QRSDetector_setTtsTMDQueue(&(me->itsQRSDetector), &(me->itsTMDQueue));
    // WavaformDisplay_setItsTMDQueue(&(me->itsWaveformDisplay), &(me->itsTMDQueue));
    // ArrythmiaDetector_setItsTMDQueue(&(me->itsArrythmiaDetector), &(me->itsTMDQueue));
}

static void cleanUpRelations(TestBuilder *const me)
{
    // WavaformDisplay_Cleanup(&(me->itsWaveformDisplay));
